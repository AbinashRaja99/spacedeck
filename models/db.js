...
module.exports = {
  User: sequelize.define('user', {
    ...
    voted_spaces:{type:Sequelize.STRING, defaultValue:''},
  ...
  Space: sequelize.define('space', {
    ...
    voting_status:{type: Sequelize.BOOLEAN, defaultValue:false},
    voted_user:{type:Sequelize.STRING, defaultValue:''},
    voting_finished:{type: Sequelize.BOOLEAN, defaultValue:false},
  ...
  Comment: sequelize.define('comment', {
    ...
    liked_by:{type:Sequelize.STRING, defaultValue:''},
  }),
